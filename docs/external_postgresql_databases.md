...
metadata:
  annotations:
    meta.helm.sh/release-name: radar-kratos
...
metadata:
  annotations:
    meta.helm.sh/release-name: radar-hydra
    meta.helm.sh/release-namespace: default
  labels:
    app.kubernetes.io/managed-by: Helm
    cnpg.io/reload: "true"
...
For Grafana, you need to create a Kubernetes Secret resource with the following specifications:

```yaml
apiVersion: v1
data:
  username: external-db-user
  password: external-db-password
  dbname: external-timescaledb-name
  host: external-postgres-host
kind: Secret
metadata:
  annotations:
    meta.helm.sh/release-name: radar-grafana
    meta.helm.sh/release-namespace: default
  labels:
    app.kubernetes.io/managed-by: Helm
    cnpg.io/reload: "true"
