...
| [step-cli](https://smallstep.com/docs/step-cli/installation)        | Used in `init` script to generate a JSON Web Key Set (JWKS) file for use with Ory Kratos.                                                                                                       |
| [jq](https://stedolan.github.io/jq/download/)                       | Used in `init` script to a JSON Web Key Set (JWKS) file for use with Ory Kratos.                                                                                                                |
